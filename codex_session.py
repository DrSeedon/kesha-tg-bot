...
class CodexSession:
    ...
    async def _consume_turn(self, turn_id: Optional[str] = None) -> AsyncGenerator[dict, None]:
        ...
        delta_items: set[tuple[str | None, str | None]] = set()
        while True:
            try:
            ...
            if method == "item/agentMessage/delta":
                ...
                if delta:
                    delta_items.add((event_turn or turn_id, params.get("itemId") or item.get("id")))
            ...
            if method == "item/completed":
                if item.get("type") == "agentMessage":
                    ...
                    if text and key not in delta_items:
