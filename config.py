...
STRINGS = {
    "ru": {
        ...
        "context_runtime_unhealthy": "⚠️ Рантайм Claude не отвечает — не смог проверить свободный контекст, поэтому сообщение не отправил. Переподключаюсь; повтори через полминуты.",
    ...
    "en": {
        ...
        "context_runtime_unhealthy": "⚠️ The Claude runtime is not responding — I could not verify free context, so I did not send your message. Reconnecting; try again in half a minute.",
