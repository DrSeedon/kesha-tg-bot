...
STRINGS = {
    "ru": {
        ...
        "context_runtime_invariant": "⚠️ Рантайм ответил не той моделью, которую ждём ({expected}). Сообщение не отправлено — проверь модель в конфиге.",
    ...
    "en": {
        ...
        "context_runtime_invariant": "⚠️ The runtime reported a different model than expected ({expected}). Message not sent — check the configured model.",
